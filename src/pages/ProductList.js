...
function ProductList({ type }) {
  ...
  const products = [
    { name: 'Grey Sofa-bed', imageSrc: product1, price: '999€', link: '/product?id=1', category: 'furniture' },
    { name: 'Wooden Chair', imageSrc: product2, price: '19€', link: '/product?id=2', category: 'furniture' },
    { name: 'Mint Bed', imageSrc: product3, price: '598€', link: '/product?id=3', category: 'furniture' },
    { name: 'Grey Sink', imageSrc: product4, price: '290€', link: '/product?id=4', category: 'furniture' },
    { name: 'Outdoor Set', imageSrc: product5, price: '3450€', link: '/product?id=5', category: 'outdoor' },
    { name: 'Outdoor Table', imageSrc: product6, price: '5€', link: '/product?id=6', category: 'outdoor' },
    { name: 'Gaming Mouse', imageSrc: product7, price: '300€', link: '/product?id=7', category: 'technology' },
    { name: 'Monitor', imageSrc: product8, price: '50€', link: '/product?id=8', category: 'technology' },
  ];
